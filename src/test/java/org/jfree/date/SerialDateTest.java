...
public class SerialDateTest extends TestCase {
    ...
    protected void setUp() {
        this.nov9Y2001 = SerialDate.createInstance(9, Month.NOVEMBER, 2001);
    }
    ...
    public void testAddMonthsTo9Nov2001() {
        final SerialDate jan9Y2002 = SerialDate.addMonths(Month.FEBRUARY, this.nov9Y2001);
        final SerialDate answer = SerialDate.createInstance(9, Month.JANUARY, 2002);
    ...
    public void testAddMonthsTo5Oct2003() {
        ...
        final SerialDate d2 = SerialDate.addMonths(Month.FEBRUARY, d1);
...
//    }
    ...
    public void testMonthCodeToStringCode() {
        ...
        String shortMonthName = SerialDate.monthCodeToString(Month.DECEMBER, true);
    ...
    public void testSerialization() {
        ...
        SerialDate d1 = SerialDate.createInstance(15, Month.APRIL, 2000);
        SerialDate d2 = null;
    ...
    public void test1096282() {
        SerialDate d = SerialDate.createInstance(29, Month.FEBRUARY, 2004);
        d = SerialDate.addYears(1, d);
        SerialDate expected = SerialDate.createInstance(28, Month.FEBRUARY, 2005);
    ...
    public void testAddMonths() {
        SerialDate d1 = SerialDate.createInstance(31, Month.MAY, 2004);

        SerialDate d2 = SerialDate.addMonths(Month.JANUARY, d1);
        assertEquals(30, d2.getDayOfMonth());
        assertEquals(6, d2.getMonth().toInt());
        assertEquals(2004, d2.getYYYY());

        SerialDate d3 = SerialDate.addMonths(Month.FEBRUARY, d1);
        assertEquals(31, d3.getDayOfMonth());
        assertEquals(7, d3.getMonth().toInt());
        assertEquals(2004, d3.getYYYY());

        SerialDate d4 = SerialDate.addMonths(Month.JANUARY, SerialDate.addMonths(Month.JANUARY, d1));
    ...
    public void testGetEndOfCurrentMonth() {
        ...
        SerialDate serialDate = SerialDate.createInstance(18, Month.APRIL, 2021);
